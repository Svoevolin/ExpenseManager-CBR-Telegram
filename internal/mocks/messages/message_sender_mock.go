...
//go:generate minimock -i github.com/Svoevolin/workshop_1_bot/internal/model/messages.MessageSender -o message_sender_mock.go -n MessageSenderMock -p messages
